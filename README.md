...
```
Total ad / tracking block list 屏蔽追踪广告总数: 146783

Total allowlist list 允许名单总数: 9940

Total combine list 结合总数： 146416
