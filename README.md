...
```
Total ad / tracking block list 屏蔽追踪广告总数: 105478

Total allowlist list 允许名单总数: 9948

Total combine list 结合总数： 105111
