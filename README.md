...
```
Total ad / tracking block list 屏蔽追踪广告总数: 147776

Total allowlist list 允许名单总数: 9942

Total combine list 结合总数： 147409
