...
```
Total ad / tracking block list 屏蔽追踪广告总数: 142505

Total allowlist list 允许名单总数: 9936

Total combine list 结合总数： 142138
