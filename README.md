...
```
Total ad / tracking block list 屏蔽追踪广告总数: 150738

Total allowlist list 允许名单总数: 9943

Total combine list 结合总数： 150371
