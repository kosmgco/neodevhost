...
```
Total ad / tracking block list 屏蔽追踪广告总数: 265501

Total allowlist list 允许名单总数: 9945

Total combine list 结合总数： 265134
