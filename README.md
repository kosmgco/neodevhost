...
```
Total ad / tracking block list 屏蔽追踪广告总数: 144754

Total allowlist list 允许名单总数: 9939

Total combine list 结合总数： 144387
